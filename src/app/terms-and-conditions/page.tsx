...
const TermsAndConditions = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-screen-xl mx-auto space-y-6 px-4 sm:px-8 md:px-12 font-montserrat">
      ...
      <div className="w-full max-w-5xl bg-transparent p-6">
        ...
        <div className="space-y-3">
          <ol className="list-decimal list-inside">
            ...
            <li className="mb-4">
              <strong>Booking Timeline:</strong> Mock tests must be booked{" "}
              <span className="font-semibold">at least 24 hours in advance</span>
              , depending on availability for the desired date.
            </li>
            <li className="mb-4">
              <strong>Valid ID Requirements:</strong> Candidates must present a
              valid <span className="font-semibold">NID or Passport</span> on the
              test day. A clear image of the ID document is acceptable if the
              physical copy is unavailable.
            </li>
            <li className="mb-4">
              <strong>Accurate Information:</strong> Candidate details, including{" "}
              <span className="font-semibold">
                Name, Money Receipt Number, and NID/Passport Information
              </span>
              , must be valid and match exactly with the information provided at
              the time of booking. Any mismatch may result in the candidate being
            ...
            <li className="mb-4">
              ...
              <ul className="list-disc list-inside ml-6">
                <li className="mb-4">
                  <strong>Cancellation Policy:</strong> Booked mock tests{" "}
                  <span className="font-semibold">cannot be canceled.</span>
                </li>
                <li className="mb-4">
                  ...
                  <ul className="list-disc list-inside ml-6">
                    <li className="mb-4">
                      ...
                      <span className="font-semibold">
                        at least 24 hours before the booked test date
                      </span>
                      .
                    </li>
                    <li className="mb-4">
                    ...
                    <li className="mb-4">
                      If the desired test date is unavailable, Luminedge is not
                      liable, and <span className="font-semibold">no refunds</span>{" "}
                      will be issued.
                    </li>
                    <li className="mb-4">
                      Rescheduling is not allowed within 24 hours of the test
                      date.
                    </li>
                  </ul>
                </li>
            ...
            <li className="mb-4">
              ...
              the scheduled date and time will be considered a{" "}
              <span className="font-semibold">no-show,</span> and the mock test
              will be treated as taken. No refunds or rescheduling options will
            ...
            <li className="mb-4">
              ...
              Luminedge office{" "}
              <span className="font-semibold">
                at least 30 minutes before the scheduled test time
              </span>
              . Late arrivals may result in automatic cancellation of the mock
              test. No refunds or rescheduling options will be provided in such
              cases.
            </li>
            <li className="mb-4">
              ...
              <ul className="list-disc list-inside ml-6">
                <li className="mb-4">
                  Candidates must follow all instructions provided by the
                  invigilator during the test.
                </li>
                <li className="mb-4">
                  Disruptive or inappropriate behavior may lead to
                  disqualification from the mock test without any refund.
                </li>
              </ul>
            </li>
            <li className="mb-4">
            ...
            <li className="mb-4">
              ...
              <ul className="list-disc list-inside ml-6">
                <li>
                  Mock tests are designed to simulate actual test conditions and
                  formats.
                </li>
                <li>
      ...
      <div className="w-full max-w-5xl bg-transparent p-3">
        <h1
        ...
        <p className="text-center mt-1 mb-4">
          In case of any emergency or if you need to communicate with us regarding
          your mock test, please contact:
        </p>
