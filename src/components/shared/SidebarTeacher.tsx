...
<li className={`group relative rounded-full overflow-hidden transition-colors duration-200 ease-in-out
  ...
  <Link href="/teacher/dashboard" className="flex items-center gap-x-3 px-4 py-3 w-full text-sm md:text-base relative z-10">
...
{/* TRF */}
<li className={`group relative rounded-full overflow-hidden transition-colors duration-200 ease-in-out
  ${pathname === "/teacher/teacherTRF"
    ? "bg-[#FACE39] text-[#00000f] font-bold"
    : "hover:text-[#00000f]"}`}>
  {/* Liquid hover effect layer */}
  <div className="absolute inset-0 before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-[#FACE39] before:rounded-full before:transition-all before:duration-500 group-hover:before:left-0 before:blur-sm z-0" />

  <Link href="/teacher/teacherTRF" className="flex items-center gap-x-3 px-4 py-3 w-full text-sm md:text-base relative z-10">
...
{/* Available Schedules */}
<li className={`group relative rounded-full overflow-hidden transition-colors duration-200 ease-in-out
  ${pathname === "/teacher/available-schedulesteacher"
    ? "bg-[#FACE39] text-[#00000f] font-bold"
    : "hover:text-[#00000f]"}`}>
  {/* Liquid hover effect layer */}
  <div className="absolute inset-0 before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-[#FACE39] before:rounded-full before:transition-all before:duration-500 group-hover:before:left-0 before:blur-sm z-0" />

  <Link href="/teacher/available-schedulesteacher" className="flex items-center gap-x-3 px-4 py-3 w-full text-sm md:text-base relative z-10">
    <IoCloudDownloadOutline className="h-5 w-5 flex-shrink-0 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-[#00000f]" />
    <span className="truncate w-full min-w-0 transition-all duration-200 group-hover:pl-1 group-hover:text-[#00000f]">
      Available Schedules
    </span>
...
{/* Booking Details */}
<li className={`group relative rounded-full overflow-hidden transition-colors duration-200 ease-in-out
  ${pathname === "/teacher/all-usersteacher"
    ? "bg-[#FACE39] text-[#00000f] font-bold"
    : "hover:text-[#00000f]"}`}>
  {/* Liquid hover effect layer */}
  <div className="absolute inset-0 before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-[#FACE39] before:rounded-full before:transition-all before:duration-500 group-hover:before:left-0 before:blur-sm z-0" />

  <Link href="/teacher/all-usersteacher" className="flex items-center gap-x-3 px-4 py-3 w-full text-sm md:text-base relative z-10">
...
{/* Home Based Booking */}
<li className={`group relative rounded-full overflow-hidden transition-colors duration-200 ease-in-out
  ${pathname === "/teacher/homebasedteacher"
    ? "bg-[#FACE39] text-[#00000f] font-bold"
    : "hover:text-[#00000f]"}`}>
  {/* Liquid hover effect layer */}
  <div className="absolute inset-0 before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-[#FACE39] before:rounded-full before:transition-all before:duration-500 group-hover:before:left-0 before:blur-sm z-0" />

  <Link href="/teacher/homebasedteacher" className="flex items-center gap-x-3 px-4 py-3 w-full text-sm md:text-base relative z-10">
