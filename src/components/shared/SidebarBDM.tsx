...
const NAV_ITEMS: Item[] = [
  { label: "Dashboard",          href: "/bdm/dashboard",              Icon: IoHomeOutline },
  { label: "Available Schedules",href: "/bdm/available-schedulesbdm", Icon: IoCloudDownloadOutline },
  { label: "Bookings Details",   href: "/bdm/all-usersbdm",           Icon: IoWalletOutline },
  { label: "Home Based Booking", href: "/bdm/homebasedbdm",           Icon: RiHomeOfficeFill },
];
...
export default function SidebarBDM() {
  ...
  return (
    <div className="flex">
      <button type="button" onClick={toggle} className="p-2 md:hidden z-50" aria-label="Toggle menu">
      ...
      >
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <button type="button" onClick={toggle} className="p-2 md:hidden" aria-label="Close menu">
